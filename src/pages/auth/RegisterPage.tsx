 ...
 * @description Formulario de registro con diseño split-screen y estética premium
 * Integrado con Supabase Auth para verificación de email
 * 
 * @iso25010
 * - Seguridad: Restricción de registro solo para clientes + verificación de email
            ...
            <div className="auth-form-panel">
                <div className="auth-form-container">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="auth-input-group">
                            <label className="auth-input-label">
                                Teléfono <span className="auth-input-label--optional">(opcional)</span>
                            </label>
                            <div className="auth-input-wrapper">
